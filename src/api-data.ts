 ...
 */
const tweetDetailFeatures = addApiFeatures({});
...
const endpoints = {
  ...
  TweetDetail:
    `https://x.com/i/api/graphql/u5Tij6ERlSH2LZvCUqallw/TweetDetail?variables=%7B%22focalTweetId%22%3A%221237110546383724547%22%2C%22with_rux_injections%22%3Afalse%2C%22includePromotedContent%22%3Atrue%2C%22withCommunity%22%3Atrue%2C%22withQuickPromoteEligibilityTweetFields%22%3Atrue%2C%22withBirdwatchNotes%22%3Atrue%2C%22withVoice%22%3Atrue%2C%22withV2Timeline%22%3Atrue%7D&features=${encodeURIComponent(JSON.stringify(tweetDetailFeatures))}&fieldToggles=%7B%22withArticleRichContentState%22%3Afalse%7D`,
  TweetDetailArticle:
